...
export const getCalendar = () => {
    return async (dispatch) => {
        try {
            fetch("http://192.168.1.3/family-portal-api/calendar.php", {
                method: "get",
                headers: {
...
export const getForecast = () => {
    return async (dispatch) => {
        try {
            fetch("http://192.168.1.3/family-portal-api/forecast.php", {
                method: "get",
                headers: {
                    Accept: "application/json",
                },
...
export const getWeather = () => {
    ...
    return async (dispatch) => {
        try {
            fetch("http://192.168.1.3/family-portal-api/weather.php", {
                method: "get",
                headers: {
                    Accept: "application/json",
                },
...
export const getJoke = () => {
    return async (dispatch) => {
        try {
            fetch("http://192.168.1.3/family-portal-api/joke.php", {
                method: "get",
                headers: {
                    Accept: "application/json",
                },
...
export const getQuote = () => {
    return async (dispatch) => {
        try {
            fetch("http://192.168.1.3/family-portal-api/quote.php", {
                method: "get",
                headers: {
                    Accept: "application/json",
                },
